...
CALL `om_CreateFormEntry`('text_and_image', 'resize', 5, 'Omega\\Utils\\Plugin\\Type\\CheckBoxes', '{"default": {"resize": false},"options": {"resize": "Yes"}}', 'Resize image', '', 0);
CALL `om_CreateFormEntry`('text_and_image', 'width', 6, 'Omega\\Utils\\Plugin\\Type\\TextSimple', '{}', 'Width', '', 0);
CALL `om_CreateFormEntry`('text_and_image', 'height', 7, 'Omega\\Utils\\Plugin\\Type\\TextSimple', '{}', 'Height', '', 0);