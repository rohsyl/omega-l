...
<head>
    ...
    <!-- Theme CSS -->
    <link href="<?= Entity::Site()->template_directory_uri ?>/css/clean-blog.css" rel="stylesheet">
    ...
    <script src="<?= Url::CombAndAbs(ABSPATH, 'assets/js/bootstrap-hover-dropdown.min.js') ?>"></script>
