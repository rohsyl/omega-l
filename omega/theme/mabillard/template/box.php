        ...
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="/">
                    <img alt="Brand" src="<?php echo Entity::Site()->template_directory_uri?>/img/Yvon_Mab_CMYK_rect.svg" style="height: 50px;">
                </a>
            </div>

            <div class="navbar-right hidden-xs hidden-sm">
                <a class="navbar-brand navbar-brand-left" href="/">
                    <img alt="Brand" src="<?php echo Entity::Site()->template_directory_uri?>/img/Personnages_Vehicule.svg" style="height: 50px;">
                </a>
            </div>
        </div>
    </nav>
