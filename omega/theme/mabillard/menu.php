...
Entity::Menu()->setMenuHtmlStruct(array(
    'ul_main' => '<ul class="nav navbar-nav navbar-left">%1$s</ul>',
    ...
    'li_childrenactiv' => '<li class="dropdown nav-item-%3$s active"><a href="%1$s" class="dropdown-toggle" data-toggle="dropdown">%2$s</a>%4$s</li>'
));


echo Entity::Menu()->getBySecurity();
