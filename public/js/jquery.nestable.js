    ...
    Plugin.prototype = {
        ...
        init: function()
        {
            ...
            list.el.on('click', 'a', function(e) {
                ...
                {
                	var onUpdate = "" +
                	"$(this).parent().parent().parent().find('.dd-handle').first().html($(this).parent().find('div input.title').first().val());" +
                	"$(this).parent().parent().parent().find('a.edit').first().data('url', $(this).parent().find('div input.url').first().val());" +
                	"$(this).parent().parent().parent().find('a.edit').first().data('title',  $(this).parent().find('div input.title').first().val());" +
					"$.growl.notice({ title : 'Success', message: 'Link updated. <br /> You must click on the Save button for it to take effect.' });"+
                	"return false;";
                	var onCancel = "" +
                	"$('.edit-form').remove(); " +
                	"return false;";
                ...
                else if($(e.currentTarget).hasClass('remove'))
                {
			    	...
			    	{
			    		$('#nestable ol:first').html('No Element');
			    	}
                	$('#edit-title').val('');
			    	$('#edit-link').val('');
                	return false;
