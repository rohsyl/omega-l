        ...
        init: function()
        {
            ...
            list.el.on('click', 'a', function(e) {
                ...
                if($(e.currentTarget).hasClass('edit'))
                {
                    ...
                    function getMenuEditForm(url, title, isNewTab){
                        var checked = (typeof isNewTab !== undefined) ? isNewTab : false;
                        return '<div id="formMenuEdit">' +
                            '<div class="form-group">' +
                            '   <label for="menuEntryUrl" class="control-label">URL / Slug</label>' +
                            '   <input type="text" id="menuEntryUrl" value="' + url + '" class="form-control" />' +
                            '</div>' +
                            '<div class="form-group">' +
                            '   <label for="menuEntryLabel" class="control-label">Label</label>' +
                            '   <input type="text" id="menuEntryLabel" value="' + title + '" class="form-control" />' +
                            '</div>' +
                            '<div class="checkbox">\n' +
                            '    <label>\n' +
                    ...
                    var mid = omega.modal.open(__('Edit menu entry'), html, __('Save'), function(){
                        ...
                        var label = title;
                        if(isNewTab)
                            label = title + ' ' + '<i class="fa fa-external-link"></i>';
