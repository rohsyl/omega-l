        ...
        <div class="page-header">
            <h2>
                ...
                <div class="toolbar">
                    ...
                    <a href="{{ \Omega\Utils\Entity\Page::GetUrl($page->id) }}" class="btn btn-info btn-tooltip" target="_blank" title="{{ __('View') }}">
                        <span class="glyphicon glyphicon-eye-open"></span> <span class="hidden-xs hidden-sm">{{ __('View') }}</span>
                    </a>
                    @if(has_right('page_disable'))
                        @if(!$page->isEnabled)
